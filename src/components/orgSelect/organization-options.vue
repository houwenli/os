    ...
    methods: {
        ...
        remoteMethod(queryString) {
            ...
            if (queryString !== '' && queryString.length > 1) {
                ...
                let params = {
                    data: {...data,...this.reqData.data},
                    op: ''
                };

                params.op = this.reqData.op || '';
                let URL = this.reqData.moduleName ? this.$getModuleUrl(this.reqData.moduleName, params.op) : '/local/selectOrgByOrgNameWithPermission';
