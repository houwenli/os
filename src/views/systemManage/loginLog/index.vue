    ...
    <ws-table-el ref="table" v-bind="tableConfig" :col="8" >
        <template #search>
            ...
            <search-group>
                ...
                <ws-date-range :startTime.sync="searchOptions.startTime" :endTime.sync="searchOptions.endTime" value-format="yyyy-MM-dd HH:mm:ss"></ws-date-range>
            </search-group>
        </template>

        <template #options>
            <div v-if="oaPowerList.selectOsLoginLog" style="float: right">
                <el-button-group>
        ...
        <template>
            ...
            <ws-table-column-el prop="depTypeName" width="250" label="部门类型"></ws-table-column-el>
            ...
            <ws-table-column-el prop="os" label="操作系统"></ws-table-column-el>
...
export default {
  ...
  data () {
    return {
        ...
        tableConfig: {
            ...
            filterColumns: false,
            lazyQuery: {
                moduleName: "/systemManage/loginLog",
                op: {
                    selectList: "selectOsLoginLog"
                },
            },
        },
        moduleName: "/systemManage/loginLog",
  ...
  methods: {
        ...
        //         op: 'exportLog',
        //     };
        //     this.$axios(this.getModuleUrl('exportLog'), reqData).then(res => {
