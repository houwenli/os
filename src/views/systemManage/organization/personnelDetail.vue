...
export default {
    ...
    methods: {
        // 根据个人ID查询个人信息
        queryIdInfo: throttle(async function () {
            if (!this.personnelId) return;
            const param = {
                data: JSON.stringify({ id: this.personnelId }),
            ...
            if (res.code == 1) {
                ...
                this.$nextTick(() => {
                    ...
                    this.tableData = detailData.udpList.map(item => {
                        return {
                            deptId: item.deptId || [],
                    ...
                    this.createEmploy[0].value = (detailData.createUser || {}).name;
                    this.createEmploy[1].value = detailData.createTime;
                    this.updateEmploy[0].value = (detailData.updateUser || {}).name;
                    this.updateEmploy[1].value = detailData.updateTime;
                    this.loading = false;
                });
            }
        },1500),
