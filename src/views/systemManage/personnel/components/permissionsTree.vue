        ...
        <div class="treeBox">
            ...
            <!-- <div class="treeSmallBox" v-if="deptType == 0">
                ...
                <div class="treeContent" >
                    ...
                    <ws-tree v-else ref="tree" :defaultProps="treeProps" node-key="id" v-loading="loading" @load="this.getOrgTreeData" lazy :set-node-expand="setNodeExpand"></ws-tree>
                </div>
            </div>
            <div class="treeSmallBox" v-if="deptType == 0">
    ...
    watch: {
        roleIds: {
            ...
            handler: async function () {
              let list = await this.loadNodeMech(this.node, this.resolve)

              if(list && list.length && list[0].id === -99) {
