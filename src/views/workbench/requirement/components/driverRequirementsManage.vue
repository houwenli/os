    ...
    <div class="requirenment-box">
        ...
        <div class="radioBox">
            <el-radio-group v-model="demandPermission" class="formRadio">
                <el-radio-button size="medium" label="1"  v-if="getModulePower('/driverDemand').daijiaDemandApplyAllList"><span>所有需求</span></el-radio-button>
                <el-radio-button size="medium" label="2"  v-if="getModulePower('/driverDemand').daijiaDemandApplyList"><span>我发起的</span></el-radio-button>
            </el-radio-group>
                ...
                <template>
                    ...
                    <ws-table-column-el fixed="right" width="160" label="操作">
                        <template v-slot="scope">
                            <el-button type="text" style="color: #0088ff" @click="goToPage(scope.row)" v-if="getModulePower('/driverDemand').detail">详情</el-button>
                            <el-button
                                type="text"
                                style="color: #0088ff"
                                v-if="(scope.row.demandStatus == 3 || scope.row.demandStatus == 4) && getModulePower('/driverDemand').submit"
                                @click="hanldeResubmit(scope.row.id, 'cxtj', 'driver')"
                            >
                                重新提交
                            </el-button>
                        </template>
        ...
        return {
            ...
            tableConfig: {
                ...
                lazyQuery: {
                    ...
                    op: {
                        selectList: 'daijiaDemandApplyList',
                        selectCount: 'daijiaDemandApplyCount',
                    },
    ...
    watch: {
        ...
        demandPermission(val) {
            if (val === '2') {
                ...
                this.tableConfig.lazyQuery.op.selectList = 'daijiaDemandApplyList';
                this.tableConfig.lazyQuery.op.selectCount = 'daijiaDemandApplyCount';
            }
            if (val === '1') {
                this.$refs.table.reset();
                this.tableConfig.lazyQuery.op.selectList = 'daijiaDemandApplyAllList';
                this.tableConfig.lazyQuery.op.selectCount = 'daijiaDemandApplyAllCount';
            }
            this.approvalStatus = '';
        },
    },
