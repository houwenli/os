    ...
    methods: {
        ...
        firstTree(list) {
            ...
            const data = list.map(item => {
                const { employschildren, departmentChildren } = item;
                this.children = [...(employschildren || []), ...(departmentChildren || [])];
                // 处理子数据，区分部门和员工
        ...
        childrenHandle(data) {
            ...
            const { departmentChildren, employschildren } = data;
            const childrenData = [...(departmentChildren || []), ...(employschildren || [])];
