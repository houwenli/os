            ...
            <el-collapse v-model="activeNames">
                <ws-descriptions title="基础信息">
                    ...
                    <ws-descriptions-item
                        label="优惠金额"
                        :showTip="false"
                    >{{getObj.preferentialPrice == null ? '-' : '' + formatAmount(getObj.preferentialPrice)+'元'}}</ws-descriptions-item>
                    <ws-descriptions-item label="福气值" :showTip="false">{{ parseFloat(getObj.lucyValueCount/100, 2) || '-' }}</ws-descriptions-item>
                    <ws-descriptions-item label="支付类型" :showTip="false">{{ payModeTypeMap[getObj.payMode] || '-' }}</ws-descriptions-item>
                ...
                <ws-descriptions title="亲友代付">
                    <ws-descriptions-item label="司机ID" :showTip="false">{{ getObj.payer || '-' }}</ws-descriptions-item>
                    <ws-descriptions-item label="手机号码" :showTip="false">{{ getObj.payerPhone  || '-' }}</ws-descriptions-item>
                </ws-descriptions>
