<template>
    <div class="import_wrap">
        ...
        <progress-list :dataResult="dataResult" :progressType="progressType" title="批量赠送"></progress-list>
    </div>
</template>
...
export default {
    data() {
        return {
            ...
            moduleName: '/workbench/baoganManage/drivingDriver/list',
            fileList: [],
            fileName: '',
        };
    },
    ...
    methods: {
        ...
        downLoad() {
            util.downloadFile('/static/xlsx/driverbgTemplate.xls', '包干批量赠送模板样式');
        },
        start() {
            ...
            formData.append('op', 'batchFreeUploading');
            formData.append('token', this.$baseMethod.getStore('_ccmUser').token);
            formData.append('data', '{}');
            let URL = this.powerList.batchFreeUploading;
