<template>
    <div class="import_wrap">
        <div class="box">
            <div class="content">
                ...
                <div class="btn-down btn-upload">
                    ...
                    <!-- <div class="time">
                        <label class="label">立即上架：</label>
                        <el-radio-group v-model="packageStatus">
        ...
        <progress-list :dataResult="dataResult" :progressType="progressType" title="批量导入减佣卡配置" :afterEmit="refresh"></progress-list>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        downLoad() {
            util.downloadFile('/static/xlsx/commissionReductionCard.xls', '减佣卡价格模板');
        },
        start() {
