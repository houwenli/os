    ...
    <div class="flex-column">
        <div class="form-wrap flex-1">
            ...
            <div class="base-content">
                ...
                <el-button v-if="defindVip.length != 6 && !disabled" type="primary" style="float: right; margin-bottom: 5px" @click="addition()">添加区间配置</el-button>
            ...
            <operating-table v-if="disabled" :module-name="moduleName" />
        </div>
...
export default {
    ...
    data() {
        return {
            ...
            moduleName: '/workbench/baoganManage/drivingPriceSet/list',
            enterQuery: null,
        };
    },
    computed: {
