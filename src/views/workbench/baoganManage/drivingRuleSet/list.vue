                ...
                <ws-table-column-el align="center" label="操作" fixed="right" width="150">
                    <template slot-scope="scope">
                        ...
                        <el-button
                            ...
                            @click="drivingFormContent('detail', scope.row.id)"
                        >详情</el-button>
                        <el-button
                            type="text"
                            style="color: #0088ff"
                            v-if="showEdit(scope.row)"
                            @click="drivingFormContent('edit', scope.row.id)"
                        >修改</el-button>
                    </template>
                </ws-table-column-el>
            </template>
...
export default {
    ...
    methods: {
        ...
        // 新增
        add(type) {
            this.$router.push({ name: 'drivingRuleSetForm', query: { type } });
        },
        // 详情||修改
        drivingFormContent(type, id) {
            this.$router.push({ name: 'drivingRuleSetForm', query: { type, id } });
        },
        search() {
