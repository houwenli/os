<template>
    <div class="import_wrap">
        ...
        <progress-list :dataResult="dataResult" :progressType="progressType" title="批量退款"></progress-list>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        downLoad() {
            util.downloadFile('/static/xlsx/runningwaterTemplate.xls', '批量退款模板样式');
        },
        start() {
