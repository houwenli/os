    ...
    <div>
        <el-collapse v-model="activeNames">
            <el-collapse-item :title="formGroup.basicFormGroup.title" name="1">
                <form-group :formGroup="formGroup.basicFormGroup | filterOneitme" :formData="originData"></form-group>
            </el-collapse-item>
            ...
            <el-collapse-item title="行程录音" name="6">
                <itineraryRecording :type="2"></itineraryRecording>
            </el-collapse-item>
        </el-collapse>
    </div>
</template>
...
export default {
            ...
            formGroup: Object.freeze({
                basicFormGroup: {
                    ...
                    attribute: [
                        ...
                        { label: '订单服务类型', name: 'requestRideType' },
                ...
                driverInfoFormGroup: {
                    ...
                    attribute: [
                        ...
                        { label: '运力服务类型', name: 'dispatchRideType', filters: 'businessTypeFilters' },
                        {
                            label: '系统合规类型',
                            name: 'driverLevel',
                        ...
                        { label: '服务场景', name: 'scenesType', filters: 'scenesTypeFilters' },
    ...
    watch: {
        dataList: {
            handler(val) {
                if (val && val.orderBasisInfoVo && val.orderEstimateVo) {
    ...
    filters: {
        filterOneitme(obj) {
            let isOrder = _this.dataList.orderBasisInfoVo && _this.dataList.orderBasisInfoVo.orderChannel == 1 ? true : false; //是否自主下单
