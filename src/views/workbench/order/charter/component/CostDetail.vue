    ...
    <div>
        <el-collapse v-model="activeNames">
             <el-collapse-item title="计费详情" name="1"> 
                <form-group v-if="dataList.charteredOrderFeeHeadVo" :formGroup="formGroup.basicFormGroup" :formData="dataList.charteredOrderFeeHeadVo"></form-group>
            </el-collapse-item>
            <el-collapse-item title="费用明细" name="2"> 
                <orderCostDetail v-if="dataList.rpcCharteredChargingServiceConsoleVo" :orderType="70" :dataList="dataList.rpcCharteredChargingServiceConsoleVo" :originData="dataList"></orderCostDetail>
            </el-collapse-item>
            <el-collapse-item v-if="rpcRepairVolist&&rpcRepairVolist.length" title="修复计费记录" name="6">
            ...
            <el-collapse-item title="乘客支付明细" name="3" v-if="passengerPayDetail&&passengerPayDetail.payRecord&&passengerPayDetail.payRecord.length">
                <costDetailInfo  :orderType="70" :passengerPayDetail="passengerPayDetail"></costDetailInfo>
            </el-collapse-item>
        ...
        watch: {
            dataList: {
                handler(val) {
                    ...
                    this.settleInfos = val.orderChannelPayDetails || {};
