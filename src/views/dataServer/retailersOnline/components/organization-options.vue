<template>
    <div class="ws-organization-options">
        <el-select v-if="showSelect" v-model="orgValue" v-bind="$attrs" class="options-wrap" :placeholder="placeholder" @change="changeOrg" clearable  :popper-append-to-body="false">
...
export default {
    ...
    props: {
        ...
        orgType: { type:  Number, default: null }, //20分公司  30服务中心  30服务站
    ...
    methods: {
        ...
        remoteMethod(queryString) {
            ...
            if (queryString !== '' && queryString.length > 1) {
                ...
                const URL = this.powerList['selectOrgByOrgType']
                if (!URL) {
