    ...
    <div style="overflow:hidden">
        <div class="stepsBox">
            ...
            <div class="stepsTop">
                ...
                <div class='stepsBtn'>
                    <div class="viewAll viewRules" @click="goSos()" v-if="sosData&&sosData.sosOrderId">
                        <span class="textStyle">查看求救详情</span>
            ...
            <!-- <div class="stepsBottom" id="stepsBottom"> -->
                <!-- <ul class="setpUl" id="setpUl" :style="{ position: 'absolute', left: 0, top: 0 }"> -->
            <swiper :options="swiperOption" class="stepsBottom" :not-next-tick="notNextTick" ref="mySwiper" >
                <swiper-slide  v-for="(item, index) in dataList" :key="index">
                        <div class="icon" :class="judgeIconStyle(item.approvalStatus)">
                            ...
                            <img style="width: 100%;height:100%" v-else-if="showCloseIcon(item.approvalStatus)" src="@/assets/index/icon_ending@2x.png" />
                        ...
                        <div class="cardContent">
                            ...
                            <div :class="['cardStyle',judgeBorderStyle(item.approvalStatus)]" @click="showPersonDia(item)">
                                <div :class="['cardTitle', judgeTitleStyle(item.approvalStatus)]">
                                    ...
                                    <!-- @/assets/index/completed_status_check.png -->
...
export default {
    ...
    computed: {
        currentIndex() {
            for (let [index, data] of this.dataList.entries()) {
                if (['3', '8', '-1'].includes(data.approvalStatus)) {
    ...
    methods: {
        ...
        judegeArrowSrc(status) {
          let statusIconMap = {
            2: arrowComplete,
            3: arrowPresent
          }

          return statusIconMap[status] || arrowUndone
        },
        judgeTitleStyle(status) {
          let styleMap = {
            2: 'titleFinish',
            3: 'titleCurrent',
            8: 'titleCurrent',
          ...
          return styleMap[status] || 'titleUndo'
        },
        judgeBorderStyle(status) {
            let borderStyleMap = {
              2: 'boderFinish',
              3: 'boderCurrent',
              8: 'boderCurrent',
            ...
            return borderStyleMap[status] || 'boderUndo'
        },
        ...
        goSos(){
            this.$router.push({ name: 'sosDetail', query: { type: this.sosData.sosFlowType, orderId: this.sosData.sosOrderId } });
        },
        goAllProcess() {
