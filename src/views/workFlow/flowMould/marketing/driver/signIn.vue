<template>
    ...
    <el-form class="flow_form" :inline="true" label-width="160px" :model="dataObject">
        ...
        <!-- <activityTime :formData="dataObject" /> -->
        ...
        <accumulatedRewards :formData="dataObject" />
...
import accumulatedRewards from '../../../components/marketing/accumulatedRewards';
import { ACTIVITY_TYPE } from '@/utils/enum';
export default {
    name: 'signIn',
    components: { dataForm, activityCrowd, activityCity, activityGift, activityRule, activityRewards, smsMsgConfig, pushMsgConfig, accumulatedRewards },
    props: {
        dataObject: {
            type: Object,
            default: () => {},
