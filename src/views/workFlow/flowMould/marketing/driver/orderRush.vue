...
import activityTime from '../../../components/marketing/activityTime.vue';
...
export default {
    name: 'orderRush',
    components: { dataForm, activityCrowd, activityCity, activityGift, activityRule, activityRewards, smsMsgConfig, pushMsgConfig, activityTime },
    props: {
        dataObject: {
            type: Object,
            default: () => {},
