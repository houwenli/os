        ...
        <ws-table-el :col="8" ref="table" v-bind="tableConfig" highlight-current-row :header-cell-style="{ background: '#F5F7FA' }">
            ...
            <template #search>
                ...
                <search-group>
                    ...
                    <el-select v-model='searchOptions.readStatus' clearable placeholder="请选择状态">
            ...
            <template #options>
                <div class="right">
                    <el-button-group v-if="getModulePower('/index/policy').informationList">
                    ...
                    <!-- <ws-throttle>
                        <el-button v-if="getModulePower('/index/policy').newsSave" plain type="primary" icon="el-icon-circle-plus" class="addButton" @click="goDetail(0)">新增</el-button>
                    </ws-throttle> -->
                </div>
            </template>
                ...
                <ws-table-column-el fixed="right" width="100" align="center" label="操作">
                    <template slot-scope="scope">
                      <!-- v-if="getModulePower('/index/policy').details"  -->
                        ...
                        <!-- <el-button v-if="getModulePower('/index/policy').newsUpdate" type="text" style="color: #0088ff" @click="goDetail(2, scope.row)">修改</el-button>
                        <el-button v-if="getModulePower('/index/policy').newsDelete" type="text" style="color: #0088ff" @click="handleDel(scope.row)">删除</el-button> -->
                    </template>
                </ws-table-column-el>
            </template>
        </ws-table-el>
