            ...
            <el-form label-position="right" label-width="160px" ref="el-form">
                ...
                <div class="block_item_container">
                    ...
                    <el-row class="block_item_wrap">
                        ...
                        <el-col :span="12">
                            <el-form-item label="当前余量：">{{ nodeForm.remainder }}</el-form-item>
                        </el-col>
                        <el-col :span="12">
                        ...
                        <el-col :span="12" v-if='nodeForm.couponsType==2'>
                            <el-form-item label="最该减免金额（元）：">{{ changeYuan(nodeForm.amountLimitation*1) }}</el-form-item>
                        </el-col>
                        ...
                        <el-col :span="12" v-if="nodeForm.availableStartTime">
