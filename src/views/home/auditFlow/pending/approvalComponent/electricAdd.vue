            ...
            <el-form label-position="right" label-width="170px" ref="el-form">
                ...
                <div class="block_item_container">
                    ...
                    <div style="margin-top:16px;">
                        <el-table ref="tableAdd" :data="nodeForm" :header-cell-style="{ background: '#F5F7FA' }" border>
                            <el-table-column prop="couponsName" label="换电券名称"/>
                            <el-table-column prop="addNum" label="补充数量" />
                            <el-table-column prop="showName" label="App显示别名" />
                            <el-table-column prop="remainder" label="余量" />
                            <el-table-column prop="couponsType" label="优惠券类型">
                                <template>
                                    满减
                                </template>
                            </el-table-column>
                            <el-table-column prop="signTime" label="优惠金额">
...
export default {
    ...
    computed: {
        nodeForm() {
            console.log(this.dataObject,'kkk');
            console.log(JSON.parse(this.dataObject.nodeFormJson),'lplpl');
